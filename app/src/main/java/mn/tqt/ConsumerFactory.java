...
public class ConsumerFactory {
    ...
    public static <K> KafkaConsumer<K, GenericRecord> buildAvroConsumer(String kafkaServer, String schemaRegistry) {
    ...
    public static <K> KafkaConsumer<K, ObjectNode> buildJsonConsumer(String kafkaServer, String schemaRegistry) {
        var props = buildDefaultProperties(kafkaServer, schemaRegistry);
